...
namespace UMISModuleApi.Controllers
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        public IActionResult getMenu(int roleID)
        {
            try
            {
                cmd = "select * from view_AllMenu where roleID="+roleID+"";
                var appMenu = dapperQuery.Qry<Menu>(cmd, _dbCon);
                return Ok(appMenu);
            }
            catch(Exception e)
        ...
        // [HttpGet("getListOfAllRoles")]
        // public IActionResult getListOfAllRoles(int roleID)
        // {
        //     try
        //     {
        //         cmd = @"DECLARE	@return_value int
        //                 EXEC	@return_value = [dbo].[sp_LoadMenuListAll_Roles]
        //                         @roleId = " + roleID + @"";
        //         var appMenu = dapperQuery.Qry<ListOfAllRoles>(cmd, _dbCon);
        //         return Ok(appMenu);
        //     }
        //     catch(Exception e)
        //     {
