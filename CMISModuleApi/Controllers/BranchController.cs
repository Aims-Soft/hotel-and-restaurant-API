...
namespace CMISModuleApi.Controllers
{
    ...
    public class BranchController : ControllerBase
    {
        ...
        [HttpGet("getBranchListWrtCompany")]
        public IActionResult getBranchListWrtCompany(int companyID)
        {
            try
            {
                cmd = "SELECT * FROM view_branchList where company_Id="+companyID+"";
                var appMenu = dapperQuery.Qry<Branch>(cmd, _dbCon);
                return Ok(appMenu);
            }
            catch (Exception e)
        ...
        public IActionResult getBranchSetup(int companyID)
        {
            try
            {
                cmd = @"SELECT branch_id,branch_name,company_branch_id FROM view_branchSetup where company_Id="+companyID+" group by branch_id,branch_name,company_branch_id";
